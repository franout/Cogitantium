...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ smac_vivado_stub.v
// Design      : smac_vivado
...
/* synthesis syn_black_box black_box_pad_pin="CLK,CE,SCLR,A[3:0],B[3:0],C[3:0],SUBTRACT,P[47:0],PCOUT[47:0]" */;
  input CLK;
  input CE;
  input SCLR;
  input [3:0]A;
