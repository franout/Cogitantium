...
#
# Generated by export_simulation on Sun Mar 08 19:27:45 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './dtpu.sh' script.
...
./dtpu.sh -noclean_files

For more information on the script, please type './dtpu.sh -help'.
