...
xilinx.com:ip:axis_accelerator_adapter:2.1\
"
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_PROCESSOR_CLK_FREQ_MHZ {650} \
 ] $axi_intc

  # Create instance: dtpu
  create_hier_cell_dtpu [current_bd_instance .] dtpu

  # Create instance: monitor, and set properties
  ...
  connect_bd_intf_net -intf_net S_AXIS_infifo_1 [get_bd_intf_pins axi_dma_infifo/M_AXIS_MM2S] [get_bd_intf_pins dtpu/S_AXIS_infifo]
  connect_bd_intf_net -intf_net S_AXIS_wm_1 [get_bd_intf_pins axi_dma_weight_mem/M_AXIS_MM2S] [get_bd_intf_pins dtpu/S_AXIS_wm]
  connect_bd_intf_net -intf_net axi_dma_csr_mem_M_AXI_MM2S [get_bd_intf_pins axi_dma_csr_mem/M_AXI_MM2S] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_infifo_M_AXI_MM2S [get_bd_intf_pins axi_dma_infifo/M_AXI_MM2S] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net axi_dma_outfifo_M_AXI_S2MM [get_bd_intf_pins axi_dma_outfifo/M_AXI_S2MM] [get_bd_intf_pins smartconnect_0/S02_AXI]
  connect_bd_intf_net -intf_net axi_dma_weight_mem_M_AXI_MM2S [get_bd_intf_pins axi_dma_weight_mem/M_AXI_MM2S] [get_bd_intf_pins smartconnect_0/S03_AXI]
  connect_bd_intf_net -intf_net dtpu_M_AXIS_outfifo [get_bd_intf_pins axi_dma_outfifo/S_AXIS_S2MM] [get_bd_intf_pins dtpu/M_AXIS_outfifo]
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M00_AXI [get_bd_intf_pins axi_dma_csr_mem/S_AXI_LITE] [get_bd_intf_pins ps7_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M03_AXI [get_bd_intf_pins axi_intc/s_axi] [get_bd_intf_pins ps7_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_axi_periph_M04_AXI [get_bd_intf_pins dtpu/S_AXI] [get_bd_intf_pins ps7_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_axi_periph_M05_AXI [get_bd_intf_pins monitor/s_axi_lite] [get_bd_intf_pins ps7_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_axi_periph_M06_AXI [get_bd_intf_pins axi_dma_outfifo/S_AXI_LITE] [get_bd_intf_pins ps7_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins ps7/S_AXI_HP0] [get_bd_intf_pins smartconnect_0/M00_AXI]

  # Create port connections
  connect_bd_net -net S00_ACLK_1 [get_bd_pins axi_dma_csr_mem/m_axi_mm2s_aclk] [get_bd_pins axi_dma_csr_mem/s_axi_lite_aclk] [get_bd_pins axi_dma_infifo/m_axi_mm2s_aclk] [get_bd_pins axi_dma_infifo/s_axi_lite_aclk] [get_bd_pins axi_dma_outfifo/m_axi_s2mm_aclk] [get_bd_pins axi_dma_outfifo/s_axi_lite_aclk] [get_bd_pins axi_dma_weight_mem/m_axi_mm2s_aclk] [get_bd_pins axi_dma_weight_mem/s_axi_lite_aclk] [get_bd_pins axi_intc/s_axi_aclk] [get_bd_pins dtpu/axi_aclk] [get_bd_pins dtpu/clk] [get_bd_pins monitor/s_axi_aclk] [get_bd_pins ps7/FCLK_CLK0] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_HP0_ACLK] [get_bd_pins ps7_axi_periph/ACLK] [get_bd_pins ps7_axi_periph/M00_ACLK] [get_bd_pins ps7_axi_periph/M01_ACLK] [get_bd_pins ps7_axi_periph/M02_ACLK] [get_bd_pins ps7_axi_periph/M03_ACLK] [get_bd_pins ps7_axi_periph/M04_ACLK] [get_bd_pins ps7_axi_periph/M05_ACLK] [get_bd_pins ps7_axi_periph/M06_ACLK] [get_bd_pins ps7_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_30M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_weight_mem/mm2s_introut] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axi_dma_csr_mem_mm2s_introut [get_bd_pins axi_dma_csr_mem/mm2s_introut] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net axi_dma_infifo_mm2s_introut [get_bd_pins axi_dma_infifo/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_outfifo_s2mm_introut [get_bd_pins axi_dma_outfifo/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net rst_ps7_30M_peripheral_aresetn [get_bd_pins axi_dma_outfifo/axi_resetn] [get_bd_pins monitor/s_axi_aresetn] [get_bd_pins ps7_axi_periph/M05_ARESETN] [get_bd_pins ps7_axi_periph/M06_ARESETN] [get_bd_pins rst_ps7_30M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_outfifo/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  ...
  assign_bd_address -offset 0x40420000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs axi_dma_csr_mem/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40430000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs axi_dma_outfifo/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x41800000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs axi_intc/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs monitor/s_axi_lite/Reg] -force
