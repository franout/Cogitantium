...
#
# Generated by export_simulation on Sun Apr 05 20:04:27 CEST 2020
#
################################################################################
...
'-reset_run' switch to the './dsp_smac_8.sh' script.

./dsp_smac_8.sh -reset_run
...
./dsp_smac_8.sh -noclean_files

For more information on the script, please type './dsp_smac_8.sh -help'.
