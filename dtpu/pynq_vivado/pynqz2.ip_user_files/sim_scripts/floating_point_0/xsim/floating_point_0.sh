...
#
# Generated by Vivado on Wed Apr 22 19:39:18 CEST 2020
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L xbip_pipe_v3_0_6 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_dsp48_addsub_v3_0_6 -L xbip_dsp48_multadd_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_16 -L floating_point_v7_1_9 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot floating_point_0 xil_defaultlib.floating_point_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim floating_point_0 -key {Behavioral:sim_1:Functional:floating_point_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_7d7d.protoinst" -protoinst "protoinst_files/pynqz2.protoinst" -log simulate.log
}
