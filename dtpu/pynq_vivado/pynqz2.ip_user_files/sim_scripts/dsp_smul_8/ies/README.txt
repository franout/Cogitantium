...
#
# Generated by export_simulation on Wed Apr 22 17:52:21 CEST 2020
#
################################################################################
...
'-reset_run' switch to the './dsp_smul_8.sh' script.

./dsp_smul_8.sh -reset_run
...
./dsp_smul_8.sh -noclean_files

For more information on the script, please type './dsp_smul_8.sh -help'.
