...
#
# Generated by export_simulation on Wed Apr 22 18:49:52 CEST 2020
#
################################################################################
...
'-reset_run' switch to the './dsp_smul_16.sh' script.

./dsp_smul_16.sh -reset_run
...
./dsp_smul_16.sh -noclean_files

For more information on the script, please type './dsp_smul_16.sh -help'.
