...
#
# Generated by export_simulation on Wed Apr 08 19:42:08 CEST 2020
#
################################################################################
...
'-reset_run' switch to the './smul_8.sh' script.
...
./smul_8.sh -noclean_files

For more information on the script, please type './smul_8.sh -help'.
