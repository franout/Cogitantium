...
#
# Generated by export_simulation on Wed Apr 08 17:29:34 CEST 2020
#
################################################################################
...
'-reset_run' switch to the './dsp_smac_32.sh' script.

./dsp_smac_32.sh -reset_run
...
./dsp_smac_32.sh -noclean_files

For more information on the script, please type './dsp_smac_32.sh -help'.
