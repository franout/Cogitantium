...
proc create_root_design { parentCell } {
  ...
  set inter_dla [ create_bd_port -dir O inter_dla ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {30} \
   ...
   CONFIG.PCW_FCLK0_PERIPHERAL_DIVISOR0 {43} \
  ...
  connect_bd_net -net nv_nvdla_wrapper_0_dlaintc2ps [get_bd_ports inter_dla] [get_bd_pins nv_nvdla_wrapper_0/dlaintc2ps] [get_bd_pins ps7/IRQ_F2P]
  connect_bd_net -net ps7_FCLK_CLK0 [get_bd_ports clk_pl] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins nv_nvdla_wrapper_0/clk] [get_bd_pins ps7/FCLK_CLK0] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_30M/slowest_sync_clk]
  connect_bd_net -net ps7_FCLK_RESET0_N [get_bd_pins ps7/FCLK_RESET0_N] [get_bd_pins rst_ps7_30M/ext_reset_in]
  connect_bd_net -net reset_n_0_1 [get_bd_ports reset_n_0] [get_bd_pins rst_ps7_30M/aux_reset_in]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins nv_nvdla_wrapper_0/test_mode] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x10000000 -offset 0x10000000 [get_bd_addr_spaces nv_nvdla_wrapper_0/M_AXI] [get_bd_addr_segs ps7/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_ps7_HP0_DDR_LOWOCM
