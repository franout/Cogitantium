...
set genomeRtd $env(RT_TMP)/2B300DFC030.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {NV_NVDLA_cdma__GB1}]"
...
set genomeName [subst -nocommands -novariables {NV_NVDLA_cdma__GB1}]
