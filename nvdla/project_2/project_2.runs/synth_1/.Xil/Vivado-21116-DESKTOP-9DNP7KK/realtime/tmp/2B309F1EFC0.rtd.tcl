...
set genomeRtd $env(RT_TMP)/2B309F1EFC0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {NV_nvdla__GC0}]"
...
set genomeName [subst -nocommands -novariables {NV_nvdla__GC0}]
