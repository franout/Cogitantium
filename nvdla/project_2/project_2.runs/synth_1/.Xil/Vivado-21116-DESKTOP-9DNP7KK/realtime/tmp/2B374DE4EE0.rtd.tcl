...
set genomeRtd $env(RT_TMP)/2B374DE4EE0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {NV_NVDLA_partition_c__GC0}]"
...
set genomeName [subst -nocommands -novariables {NV_NVDLA_partition_c__GC0}]
