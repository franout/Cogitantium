...
set cached_ip [config_ip_cache -export -no_bom  -dir D:/uni/2019-2020/thesis/cogitantium/nvdla/project_2/project_2.runs/reset_system_synth_1 -new_name reset_system -ip [get_ips reset_system]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top reset_system -part xc7z020clg400-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix reset_system_ reset_system.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ reset_system_stub.v
 lappend ipCachedFiles reset_system_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ reset_system_stub.vhdl
 lappend ipCachedFiles reset_system_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ reset_system_sim_netlist.v
 lappend ipCachedFiles reset_system_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ reset_system_sim_netlist.vhdl
 lappend ipCachedFiles reset_system_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp reset_system.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips reset_system]
}

rename_ref -prefix_all reset_system_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef reset_system.dcp
