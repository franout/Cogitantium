...
#
# Generated by export_simulation on Fri Jan 31 18:27:51 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './reset_system.sh' script.

./reset_system.sh -reset_run
...
./reset_system.sh -noclean_files

For more information on the script, please type './reset_system.sh -help'.
