proc ps7_pll_init_data_3_0 {} {
    ...
    mask_write 0XF8000114 0x003FFFF0 0x001902C0
    mask_write 0XF8000104 0x0007F000 0x00019000
...
proc ps7_clock_init_data_3_0 {} {
    mwr -force 0XF8000008 0x0000DF0D
    mask_write 0XF8000128 0x03F03F01 0x00302901
...
proc ps7_ddr_init_data_3_0 {} {
    ...
    mask_write 0XF8006004 0x0007FFFF 0x0000104C
    ...
    mask_write 0XF8006014 0x001FFFFF 0x00040C90
    mask_write 0XF8006018 0xF7FFFFFF 0x431528CF
    ...
    mask_write 0XF8006034 0x13FF3FFF 0x00010D64
    ...
    mask_write 0XF80060A8 0x0FFFFFFF 0x03E07735
    mask_write 0XF80060AC 0x000001FF 0x00000132
    ...
    mask_write 0XF800612C 0x000FFFFF 0x0002D411
    mask_write 0XF8006130 0x000FFFFF 0x0002980A
    mask_write 0XF8006134 0x000FFFFF 0x0002A807
    mask_write 0XF8006138 0x000FFFFF 0x0002CC13
    ...
    mask_write 0XF8006154 0x000FFFFF 0x00000091
    mask_write 0XF8006158 0x000FFFFF 0x0000008A
    mask_write 0XF800615C 0x000FFFFF 0x00000087
    mask_write 0XF8006160 0x000FFFFF 0x00000093
    mask_write 0XF8006168 0x001FFFFF 0x0000010A
    mask_write 0XF800616C 0x001FFFFF 0x000000FB
    mask_write 0XF8006170 0x001FFFFF 0x000000FF
    mask_write 0XF8006174 0x001FFFFF 0x00000108
    mask_write 0XF800617C 0x000FFFFF 0x000000D1
    mask_write 0XF8006180 0x000FFFFF 0x000000CA
    ...
    mask_write 0XF80062B0 0x003FFFFF 0x000050B5
    mask_write 0XF80062B4 0x0003FFFF 0x00000B63
...
proc ps7_ddr_init_data_2_0 {} {
    mask_write 0XF8006000 0x0001FFFF 0x00000080
    mask_write 0XF8006004 0x1FFFFFFF 0x0008104C
    mask_write 0XF8006008 0x03FFFFFF 0x03C0780F
    mask_write 0XF800600C 0x03FFFFFF 0x02001001
    mask_write 0XF8006010 0x03FFFFFF 0x00014001
    mask_write 0XF8006014 0x001FFFFF 0x00040C90
