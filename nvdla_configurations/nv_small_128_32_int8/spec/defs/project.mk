...
NVDLA_PRIMARY_MEMIF_WIDTH := 16
NVDLA_SECONDARY_MEMIF_MAX_BURST_LENGTH := 1
NVDLA_SECONDARY_MEMIF_WIDTH := 128
...
NVDLA_PRIMARY_MEMIF_WIDTH_LOG2 := 1
NVDLA_SECONDARY_MEMIF_WIDTH_LOG2 := 4
...
NVDLA_VMOD_PRIMARY_BANDWIDTH := 0
...
NVDLA_VMOD_CDP_RDMA_OUTPUT_THROUGHPUT_USE := 0
NVDLA_VMOD_PDP_RDMA_OUTPUT_THROUGHPUT_USE := 0
NVDLA_VMOD_SDP_MRDMA_OUTPUT_THROUGHPUT_USE := 0
NVDLA_VMOD_SDP_BRDMA_OUTPUT_THROUGHPUT_USE := 0
NVDLA_VMOD_SDP_NRDMA_OUTPUT_THROUGHPUT_USE := 0
NVDLA_VMOD_SDP_ERDMA_OUTPUT_THROUGHPUT_USE := 0
NVDLA_VMOD_CDP_RDMA_LATENCY_FIFO_DEPTH := 4
NVDLA_VMOD_PDP_RDMA_LATENCY_FIFO_DEPTH := 4
NVDLA_VMOD_SDP_MRDMA_LATENCY_FIFO_DEPTH := 4
NVDLA_VMOD_SDP_BRDMA_LATENCY_FIFO_DEPTH := 4
