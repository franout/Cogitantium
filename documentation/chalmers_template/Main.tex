...
\newcommand{\oneLineTitle}{FPGA-based Tensor Accelerator for Machine Learning}

\newcommand{\multiLineTitle}[1]{FPGA-based Tensor Accelerator \\[#1]for Machine Learning}
