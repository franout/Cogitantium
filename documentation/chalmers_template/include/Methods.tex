...
\captionsetup{justification=centering}
    \centering
    \subfloat[without delegate]{{\includegraphics[scale=0.45]{./figure/exec_graph.PNG} }}%
    \qquad
    \centering
    \subfloat[with delegate]{{\includegraphics[scale=0.45]{./figure/exec_graph_delegate.PNG} }}%
