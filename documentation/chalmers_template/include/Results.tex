...
\centering
\captionsetup{justification=centering}
\includegraphics[scale=0.6,angle=0]{./figure/graphs/power_pldyn_div_int8_freq_30mhz.pdf}
...
\centering
\captionsetup{justification=centering}
\includegraphics[scale=0.4,angle=0]{./figure/graphs/roofline.pdf}
...
\centering
\captionsetup{justification=centering}
\includegraphics[scale=0.4,angle=0]{./figure/graphs/roofline_vectorized.pdf}
