proc getPresetInfo {} {
  return [dict create name {zynq_block_system_configuration} description {zynq_block_system_configuration}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {zynq_block_system_configuration} ]
}
